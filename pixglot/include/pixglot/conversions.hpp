...
void convert_gamma(pixel_storage&, float, float);
...
void convert_endian(pixel_storage&, std::endian, std::endian = std::endian::native);
...
void convert_orientation(pixel_storage&, square_isometry, square_isometry = {});
...
void convert_storage(image&, pixel_target);
void convert_storage(frame&, pixel_target);
void convert_storage(pixel_storage&, pixel_target);
